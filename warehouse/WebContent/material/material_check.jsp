...
<div style="padding-Top:5px;background:#ddd; height:40px">
    <form action="material_add.jsp" method="post">    
	      <input style="float:left;" type="submit" onclick="javascript:window.location.href='material_add.jsp'" value="添加物料" class="getS" />
	  	 <input value="返回首页" type="button" onclick="window.location='interface.jsp'"class="getS">
	</form>
</div>
<div class="row">
